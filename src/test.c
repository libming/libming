...
void
testDrawCharacter (SWFMovie movie)
{
  SWFShape shape = newSWFShape ();
...
testMorph (SWFMovie movie)
{
  ...
  for (i = 0; i < 20; ++i)
  {
    SWFShape_drawLineTo (shape1, rand () % 2000 - 1000,
			 rand () % 2000 - 1000);
    SWFShape_drawLineTo (shape2, rand () % 2000 - 1000,
			 rand () % 2000 - 1000);
  }
