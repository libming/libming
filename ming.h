...
void SWFButton_addSound (SWFButton button, SWFSound sound, byte flags);
...
void SWFMovieClip_setSoundStream (SWFMovieClip clip, SWFSound sound,
				  float rate);
...
void SWFMovie_setSoundStream (SWFMovie movie, SWFSoundStream soundstream);
...
#define SWFSOUND_COMPRESSION      0xf0
#define SWFSOUND_NOT_COMPRESSED   (0<<4)
#define SWFSOUND_ADPCM_COMPRESSED (1<<4)
#define SWFSOUND_MP3_COMPRESSED   (2<<4)

#define SWFSOUND_RATE             0x0c
#define SWFSOUND_5KHZ             (0<<2)
#define SWFSOUND_11KHZ            (1<<2)
#define SWFSOUND_22KHZ            (2<<2)
#define SWFSOUND_44KHZ            (3<<2)

#define SWFSOUND_BITS             0x02
#define SWFSOUND_8BITS            (0<<1)
#define SWFSOUND_16BITS           (1<<1)

#define SWFSOUND_CHANNELS         0x01
#define SWFSOUND_MONO             (0<<0)
#define SWFSOUND_STEREO           (1<<0)
