...
my $b = new SWF::Button;
my $br1 = $b->addCharacter($s, SWF::Constants::SWFBUTTON_HIT|SWF::Constants::SWFBUTTON_UP|SWF::Constants::SWFBUTTON_OVER|SWF::Constants::SWFBUTTON_DOWN);

my $br2 = $b->addCharacter($s, SWF::Constants::SWFBUTTON_OVER|SWF::Constants::SWFBUTTON_DOWN);
$br2->rotate(10);
$br2->move(20,0);
